"use strict";(()=>{var e={};e.id=4830,e.ids=[4830],e.modules={11185:e=>{e.exports=require("mongoose")},20145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},56249:(e,a)=>{Object.defineProperty(a,"l",{enumerable:!0,get:function(){return function e(a,t){return t in a?a[t]:"then"in a&&"function"==typeof a.then?a.then(a=>e(a,t)):"function"==typeof a&&"default"===t?a:void 0}}})},41014:(e,a,t)=>{t.r(a),t.d(a,{config:()=>d,default:()=>m,routeModule:()=>y});var i={};t.r(i),t.d(i,{default:()=>u});var o=t(71802),n=t(47153),s=t(56249),r=t(61244),c=t(11185),l=t.n(c),p=t(53182);async function u(e,a){if("POST"!==e.method)return a.setHeader("Allow",["POST"]),a.status(405).json({message:"Method Not Allowed"});let{templateId:t,variables:i}=e.body;if(!t)return a.status(400).json({message:"templateId is required"});try{await (0,r.u)();let e=l().connection.db,o=await e.collection("emailTemplates").findOne({id:t});if(o||(o=p.t.find(e=>e.id===t)),!o)return a.status(404).json({message:"Email template not found"});let n=o.subject,s=o.body;return i&&Object.entries(i).forEach(([e,a])=>{let t=RegExp(`{{${e}}}`,"g");n=n.replace(t,a),s=s.replace(t,a)}),a.status(200).json({subject:n,body:s})}catch(e){return console.error("Error previewing email template:",e),a.status(500).json({message:"Internal server error"})}}let m=(0,s.l)(i,"default"),d=(0,s.l)(i,"config"),y=new o.PagesAPIRouteModule({definition:{kind:n.x.PAGES_API,page:"/api/email-templates/preview",pathname:"/api/email-templates/preview",bundlePath:"",filename:""},userland:i})},53182:(e,a,t)=>{t.d(a,{t:()=>i});let i=[{id:"application_submitted",name:"Application Submitted",subject:"Application Received - {{jobTitle}} at {{companyName}}",body:`Dear {{applicantName}},
